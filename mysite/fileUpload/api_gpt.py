...
def create_chat_messages(latex_formula):
    return [
        {"role": "system", "content": "당신은 복잡한 수학 문제를 이해하고 풀 수 있는 능력을 가진 지능형 조수입니다. "\
        "LaTeX 표기법에 익숙합니다. 그리고 수식의 각 부분을 분석하고, 그 의미를 설명할 수 있습니다. "\
        "또한, 수학적 원리를 기반으로 문제를 풀이하고, 이 과정을 단계별로 설명할 수 있습니다."},
        ...
        {"role": "assistant", "content": f"이 수식을 더 자세히 배우기 위해 어떤 웹사이트를 방문하는 것이 좋을까요? "\
        "수식에 대한 설명이 포함된 사이트를 추천 부탁드립니다."}
    ]
